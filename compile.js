...
const fs = require('fs');
//const cmdSpec = require('./spec/vsp-full-spec.json');
const cmdSpec = require('./spec/24-full-spec.json');
...
function compile(spec) {
	...
	myTree([], spec);
	fs.copyFile('./cmd', dir + '/cmd', () => {});
	fs.copyFile('./drv.core', dir + '/drv.core', () => {});
	fs.copyFile('./drv.nsx.client', dir + '/drv.nsx.client', () => {});
	fs.copyFile('./drv.vsp.client', dir + '/drv.vsp.client', () => {});
	fs.copyFile('./sddc.parameters', dir + '/sddc.parameters', () => {});
}
...
function writeLeaf(fileName) {
	...
	*/})
	...
	fs.chmodSync(dir + fileName, 0o755);
}
